...
export default function PracticeZonePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FAFC]">
      <Header 
        title="Practice Zone" 
        description="Sharpen your skills with curated practice and track your improvement." 
        showSearch={false} 
      />
      ...
      <div className="p-8 space-y-8 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {[
            ...
            { label: 'Rank', val: 'Top 28%', trend: 'Among active learners', icon: Trophy, color: 'text-primary-purple', bg: 'bg-primary-purple/10' },
          ].map((stat, idx) => (
            <div key={idx} className="bg-white rounded-2xl p-5 border border-slate-100 shadow-[0_2px_4px_rgba(0,0,0,0.02)] flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <div className="flex flex-col">
                  ...
                  <p className={`text-[10px] font-bold ${stat.color === 'text-orange-500' || stat.color === 'text-primary-purple' ? 'text-orange-500' : 'text-green-500'} flex items-center gap-1 whitespace-nowrap`}>
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-end">
            <div>
              <h2 className="text-xl font-bold text-brand-navy">What would you like to practice today?</h2>
              <p className="text-slate-500 text-sm mt-1">Choose a mode that fits your goal</p>
            </div>
            <button className="flex items-center gap-2 bg-white border border-primary-purple/20 text-primary-purple px-4 py-2.5 rounded-xl text-xs font-bold hover:bg-primary-purple/5 transition-all shadow-sm">
              <Sparkles size={14} className="text-primary-purple" /> AI Recommend
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={idx} className="bg-white rounded-2xl p-5 group cursor-pointer border border-slate-100 hover:border-primary-purple/20 hover:shadow-lg transition-all flex flex-col items-center text-center">
                ...
                <h3 className="text-sm font-bold text-brand-navy mb-1">{mode.title}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="divide-y divide-slate-50">
                {[
                  { name: 'Arrays & Hashing', priority: 'High Priority', accuracy: '60%', questions: '30 Questions', icon: Code2, color: 'text-green-600', bg: 'bg-green-50', pColor: 'text-primary-purple', pBg: 'bg-primary-purple/10' },
                  ...
                  <div key={idx} className="px-6 py-4 flex items-center gap-4 hover:bg-slate-50/50 transition-colors">
                    ...
                    <div className="flex flex-col items-end gap-1.5">
                      ...
                      <button className="px-5 py-1.5 rounded-lg border border-primary-purple/20 text-primary-purple text-[11px] font-bold hover:bg-primary-purple hover:text-white transition-all">
                        Start
                      </button>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="px-8 py-5 border-b border-slate-50 flex justify-between items-center">
                <h3 className="font-bold text-brand-navy text-base">Continue Your Practice</h3>
                <button className="text-primary-purple text-[11px] font-bold hover:underline">View All</button>
              </div>
              <div className="divide-y divide-slate-50">
                {[
                  ...
                  <div key={idx} className="px-8 py-[28px] flex items-center gap-6">
                    ...
                    <button className="px-8 py-3 rounded-2xl border-2 border-primary-purple/20 text-primary-purple text-sm font-bold hover:bg-primary-purple hover:text-white transition-all shadow-sm ml-4">
                      Continue
                    </button>
                  </div>
                ))}
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="px-8 py-5 border-b border-slate-50 flex justify-between items-center">
                <h3 className="font-bold text-brand-navy text-base">Your Weak Areas</h3>
                <button className="text-primary-purple text-[11px] font-bold hover:underline">View All</button>
              </div>
              <div className="p-8 space-y-6">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-6">
                    ...
                    <button className="text-[11px] font-bold text-primary-purple hover:underline">Practice</button>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-50 flex justify-between items-center">
                <h3 className="font-bold text-brand-navy text-sm">Recent Practice Performance</h3>
                <button className="text-primary-purple text-[10px] font-bold hover:underline">View All</button>
              </div>
              <div className="p-5">
                <div className="flex items-center gap-5 mb-5">
                  <div className="flex items-center gap-2">
                    <div className="w-2.5 h-2.5 rounded-full bg-primary-purple" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-100 shadow-sm p-8 flex items-center gap-10">
            <div className="w-20 h-20 bg-primary-purple/10 text-primary-purple rounded-3xl flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1 space-y-5">
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <p className="text-xl font-black text-brand-navy">Solve 300 questions</p>
                </div>
                <div className="text-right">
                  <span className="text-lg font-black text-brand-navy">210 / 300</span>
            ...
            <button className="px-8 py-3.5 bg-white text-primary-purple rounded-2xl text-sm font-bold hover:bg-primary-purple/5 transition-all border border-primary-purple/20 shadow-sm whitespace-nowrap">
              View Goals
            </button>
          </div>
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="font-bold text-brand-navy text-base">Achievements Unlocked</h3>
            ...
            <div className="flex items-center gap-8">
              {[
                { icon: Trophy, color: 'text-primary-purple/60', bg: 'bg-primary-purple/10', count: '100' },
      ...
      <div className="fixed left-6 bottom-32 w-60 p-7 bg-[#0F172A]/95 backdrop-blur-2xl border border-white/10 rounded-[32px] hidden xl:block shadow-2xl z-50 overflow-hidden group">
        <div className="absolute top-0 right-0 w-32 h-32 bg-primary-purple/20 blur-[80px] rounded-full -mr-16 -mt-16 group-hover:bg-primary-purple/50/30 transition-all"></div>
        <div className="relative text-center space-y-6">
          <div className="w-20 h-20 bg-gradient-to-br from-indigo-500/20 to-violet-500/20 rounded-full flex items-center justify-center mx-auto border border-white/5 relative group-hover:scale-110 transition-transform">
            <div className="absolute inset-0 bg-primary-purple/20 blur-2xl rounded-full animate-pulse"></div>
            <Target size={40} strokeWidth={1.5} className="text-primary-purple/60 relative" />
          </div>
          <div>
            ...
            <p className="text-slate-400 text-xs mt-3 leading-relaxed px-2">
              You practiced <span className="text-primary-purple/60 font-bold">5 times</span> this week. Keep it up!
            </p>
          </div>
          <button className="w-full py-4 bg-gradient-to-r from-primary-purple to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white rounded-2xl text-xs font-black transition-all shadow-[0_10px_20px_-5px_rgba(79,70,229,0.4)]">
            View Streak
          </button>
        </div>
      </div>
